...
argument.
Om vi till exempel vill ha dokumentation om just \term{man} självt skriver vi 
\term{man man} och får resultatet i \prettyref{lst:manman}.
...
efter namnet på manualsidan -- exempelvis \term{man(1)}.
För att specificera en särskild sektion anges sektionen innan namnet på 
manualsidan (kommandot) som argument till \term{man}, exempelvis \term{man 
1 man}.
Oftast behövs dock inte detta, det är bara när ett uppslagsnamn finns i flera 
sektioner.
Det framgår i \prettyref{lst:manman} att det är \term{man(1)} som ges av 
\term{man man}, alltså samma resultat som vid \term{man 1 man}.
Dessa manualer finns även tillgängliga online på URL
\begin{center}
	\url{https://www.kernel.org/doc/man-pages/}.
\end{center}
De manualsidor som bör läsas översiktligt i förväg är \term{bash(1)} och 
\term{man(1)}.
