...
$ find / -type d -print | less
	...
	\question\label{q:fs}
	\begin{parts}
		\part\label{qp:relative} Använd ls(1), pwd(1), cd och eventuella andra 
		program eller kommandon du behöver för att undersöka vad de speciella 
		katalogerna ''.'' respektive ''..'' som finns i varje katalog är.
		...
		fordrar inget svar.
		Använd cd och ls(1) för att utforska filsystemet.
